...
\vspace{-0.16cm}
```
-   Authoritarian regimes, Regime survival, Comparative institutions, Political
    economics of inequality and redistribution

\vspace{7pt}

<!-- RESEARCH INTERESTS: 2ND BULLET-->
...
\vspace{-0.16cm}
```
-   Democratic diffusion, Economic shocks, Economic sanctions, Foreign aids

\vspace{7pt}

<!-- PEERREVIEWED : 1ST BULLET-->
...
-   Principal investigator: Professor Wilson C. Matthew (Political Science,
...
-   A Study on Activation of Democratic Political Participation in the
    Post-COVID-19 Era
-   Principal investigator: Professor Jaemook Lee (Political Science, Hankuk
    University of Foreign Studies)
-   Co-investigator: Dr. Soohyun Jung (Korea Institute for Future Politics,
    Myongji University)
-   Co-investigator: Dr. Youngdeuk Park (Political Science, Chungnam National
    University)
...
-   Co-Principal investigator: M.A. Chaehoon Lee (Korean Standards Association)
...
-   Principal investigator: Dr. Ilgi Kim (The Institute for National Security
    Strategy)
...
-   Principal investigator: Professor Sanghwan Lee (Political Science, Hankuk
    University of Foreign Studies)
...
-   First Session: June 22nd-July 17th, 2020
    ...
    1.  Bayesian Modeling for the Social Sciences I: Introduction and
        Application
    2.  Maximum Likelihood Estimation I: Generalized Linear Models
    3.  Introduction to Python (July 6-17)

-   Second Session: July 20th-August 14th, 2020

    1.  Game Theory
    2.  Bayesian Modeling for the Social Sciences II: Advanced Topics
    3.  Causal Inference for the Social Sciences

\vspace{7pt}

\textbf{Computing Skills}: R, STATA, Python, \LaTeX,
[Quarto](https://quarto.org/), Markdown, Git & [Github](www.github.com)
